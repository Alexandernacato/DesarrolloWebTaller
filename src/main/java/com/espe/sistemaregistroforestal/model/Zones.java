...
public class Zones {
    ...
    private TipoBosque tipo_bosque; 
    ...
    public TipoBosque getTipo_bosque() { return tipo_bosque; } 
    public void setTipo_bosque(TipoBosque tipo_bosque) { this.tipo_bosque = tipo_bosque; } 
